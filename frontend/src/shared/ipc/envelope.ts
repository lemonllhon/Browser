...
export const METHOD_APP_PERFORMANCE_SNAPSHOT_GET = 'trace.app.PerformanceSnapshotGet'
export const METHOD_APP_DATA_VERSIONS_GET = 'trace.app.DataVersionsGet'
...
export const METHOD_APP_PROFILE_TRANSFER_LINK_CONSUME = 'trace.app.ProfileTransferDeepLinkConsume'
...
export const METHOD_CLOUD_SYNC_STATUS_GET = 'trace.cloudSync.StatusGet'
export const METHOD_CLOUD_SYNC_LOGIN_BIND = 'trace.cloudSync.LoginBind'
export const METHOD_CLOUD_SYNC_OAUTH_START = 'trace.cloudSync.OAuthStart'
export const METHOD_CLOUD_SYNC_REFRESH_STATUS = 'trace.cloudSync.RefreshStatus'
export const METHOD_CLOUD_SYNC_LOGOUT = 'trace.cloudSync.Logout'
export const METHOD_CLOUD_SYNC_ENCRYPTION_SETUP = 'trace.cloudSync.EncryptionSetup'
export const METHOD_CLOUD_SYNC_ENCRYPTION_UNLOCK = 'trace.cloudSync.EncryptionUnlock'
export const METHOD_CLOUD_SYNC_ENCRYPTION_DISABLE = 'trace.cloudSync.EncryptionDisable'
export const METHOD_CLOUD_SYNC_BACKUP_LIST = 'trace.cloudSync.BackupList'
export const METHOD_CLOUD_SYNC_BACKUP_UPLOAD = 'trace.cloudSync.BackupUpload'
export const METHOD_CLOUD_SYNC_BACKUP_DOWNLOAD = 'trace.cloudSync.BackupDownload'
export const METHOD_CLOUD_SYNC_BACKUP_RESTORE = 'trace.cloudSync.BackupRestore'
export const METHOD_CLOUD_SYNC_BACKUP_DELETE = 'trace.cloudSync.BackupDelete'
export const METHOD_CLOUD_SYNC_PROFILE_BACKUP_UPLOAD = 'trace.cloudSync.ProfileBackupUpload'
export const METHOD_CLOUD_SYNC_PROFILE_BACKUP_PREPARE_RESTORE = 'trace.cloudSync.ProfileBackupPrepareRestore'
export const METHOD_CLOUD_SYNC_PROFILE_TRANSFER_SHARE_CREATE = 'trace.cloudSync.ProfileTransferShareCreate'
export const METHOD_CLOUD_SYNC_PROFILE_TRANSFER_SHARE_RESOLVE = 'trace.cloudSync.ProfileTransferShareResolve'
export const METHOD_CLOUD_SYNC_PROFILE_TRANSFER_SHARE_PREPARE = 'trace.cloudSync.ProfileTransferSharePrepareRestore'
